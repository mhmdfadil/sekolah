...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li><a class="nav-link  active" href="{{ route('siswa')}}"><i class="bi bi-people"></i> Siswa</a></li>
...
<table id="siswa" class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->nisn }}</td>
                <td>
                    <form action="{{ route('siswa.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus siswa ini?')">
                        @csrf
                        @method('DELETE')
