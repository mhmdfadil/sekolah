...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li><a class="nav-link active" href="{{ route('mp')}}"><i class="bi bi-person"></i> Mata Pelajaran</a></li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('mp.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="mp" class="form-label">Mata Pelajaran</label>
                            <input type="text" class="form-control" name="mp" required>
                        </div>
...
<table id="mp" class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->mp }}</td>
                <td>
                    <form action="{{ route('mp.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus mata pelajaran ini?')">
                        @csrf
                        @method('DELETE')
