...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li><a class="nav-link active" href="{{ route('guru')}}"><i class="bi bi-boxes"></i> Guru</a></li>
...
<table id="guru" class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->nip }}</td>
                <td>
                    <form action="{{ route('guru.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus guru ini?')">
                        @csrf
                        @method('DELETE')
